      ...
      <div className="bg-white border border-slate-200 rounded-2xl shadow-sm min-h-[56px] flex flex-col overflow-hidden">
        ...
        <div className="flex items-end">
          <textarea
            ...
            disabled={disabled}
            className="flex-1 min-h-[56px] max-h-[120px] p-4 pr-2 resize-none border-0 bg-transparent text-slate-900 placeholder:text-slate-500 text-sm focus:outline-none"
            rows={1}
          />
