...
const history: HistoryItem[] = [
  {
    ...
    subtitle: '25/09/2025 17:30 17min - João da Silva Castro',
  ...
  },
  {
    ...
    subtitle: '24/09/2025 11:15 12min - Maria Costa Villar',
  ...
  },
  {
    ...
    subtitle: '23/09/2025 09:00 21min - Pedro Alves',
...
const Transcricao: React.FC = () => {
  ...
  const handleSaveClick = () => {
    setIsEditing(false);
    // Aqui você poderia salvar a `displayedContent`
  };
  ...
  return (
    <>
      <div className="flex h-full bg-background">
        {/* Main Content */}
        <div className="flex-1 flex flex-col px-6 pt-6 relative">
          <div className="flex-1 overflow-y-auto pb-48">
            {isEditing ? (
              ...
              <div
                className="text-lg max-w-none text-foreground whitespace-pre-wrap"
