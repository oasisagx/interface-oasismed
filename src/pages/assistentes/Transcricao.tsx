...
const history: HistoryItem[] = [
  {
    ...
    subtitle: '25/09/2025 - João da Silva Castro',
  ...
  },
  {
    ...
    subtitle: '24/09/2025 - Maria Costa Villar',
  ...
  },
  {
    ...
    subtitle: '23/09/2025 - Pedro Alves',
...
const Transcricao: React.FC = () => {
  ...
  const [selectedHistory, setSelectedHistory] = useState<HistoryItem | null>(history[0]);
